...
|  |  |
| --- | --- |
| **Fixed Needs** | **Fixed Wants** |
| Rent Car Insurance Renter’s Insurance | TV Package Spotify Account Gym Membership |
| **Variable Needs** | **Variable Wants** |
| Gas for car Electricity Groceries | Eating Out Birthday Gifts Manicure |
...
Following the pay-yourself-first strategy means you would rather hit your savings goals and occasionally be late paying other expenses, than wait until the end of the month and only save what is left over. Your savings goal sits at the very top of your fixed needs category every month. So you consistently build up your savings account.
...
|  |  |
| --- | --- |
|  | A. A tool to track income and expenses |
|  | B. A list of things you want to buy |
|  | C. A restriction on spending |
...
|  |  |
| --- | --- |
|  | A. To keep spending under control |
|  | B. To help achieve financial goals |
|  | C. To restrict spending |
|  | D. To always have extra income |
...
|  | B. Expenses where the cost stays the same from one month to the next |
|  | C. Unnecessary expenses |
...
|  | B. Setting aside money for savings before paying bills |
|  | C. Not saving money at all |
|  | D. Only spending money on wants |

**What is an Emergency Fund?**

|  |  |
| --- | --- |
|  | A. Money set aside for wants |
|  | B. Money set aside for large, unexpected expenses |
|  | C. Money invested in stocks |
|  | D. Money for daily expenses |
