...
![DOS](/images/1611d06491daa553.png)
...
![NODP](/images/8f3b920acc39b55e.png)
...
![TOT](/images/4cf376d6ba6b7f15.png)
...
**Use the Quotes tool to find the annual income statement and balance sheet for Ford (F) in 2016 and 2015. In 2016, Ford's Inventory Turnover Ratio…**
...
|  | Went down |
|  | Stayed the same |
|  | Not possible to calculate using only these financial statements |

**Use the Quotes tool to find the annual income statement and balance sheet for Ford (F) in 2016 and 2015. What happened to the Total Asset Turnover?**
...
**Compare Ford (F) with Walmart (WMT) in 2016. Based on the Days of Sales Oustanding ratio, which company looks like a better investment?**

|  |  |
| --- | --- |
|  | Ford |
|  | Walmart |
|  | This ratio cannot be calculated using these financial statements |
|  | Cannot compare, since this ratio is only useful comparing companies in the same industry |
