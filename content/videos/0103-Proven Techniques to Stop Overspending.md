...
*[Can’t view on YouTube? Click Here](https://learn.stocktrak.com/wp-content/uploads/2023/10/Your-Personal-Finance-Mantra-1.mp4)*

### Start with a Clear Goal

![goal](/images/af526fc8b46f3b48.jpg)
...
![savigns](/images/c7634ca369ec52b1.png)
...
![online purchase](/images/1ef1f9d361332494.jpg)
...
|  |  |
| --- | --- |
|  | A. Savings are only added to your budget if there is money left over. |
|  | B. It is a type of savings account that earns the highest interest rates. |
|  | C. It is when savings are taken out of a paycheck before taxes. |
|  | D. It is when your monthly savings goals are met before paying for any other expenses. |

**What is a good way to plan for emergencies while maintaining long-term savings growth?**

|  |  |
| --- | --- |
|  | A. Spend all your money on unnecessary expenses and hope that emergencies never happen. |
|  | B. Open a separate savings account or safety box for emergency cash. |
|  | C. Use credit cards for emergency expenses. |
|  | D. Withdraw from long-term savings to pay for emergencies. |

**How can one reduce impulse purchases?**

|  |  |
| --- | --- |
|  | A. Increase the number of credit cards you own. Withdraw from long-term savings to pay for emergencies. |
|  | B. Opt-out of over drafting. |
|  | C. Go shopping when you’re hungry. |
|  | D. Add items to a wish list for a week before making a purchase. |

**What is a fool-proof way to limit spending when all else fails?**

|  |  |
| --- | --- |
|  | A. Use credit cards for all purchases. |
|  | B. Make impulse purchases. |
|  | C. Leave credit and debit cards locked up at home, and use a prepaid debit card for purchases. |
|  | D. Increase spending limits on credit cards. |

**What is the purpose of setting clear, specific goals when creating a budget or spending plan?**

|  |  |
| --- | --- |
|  | A. To show off your money management skills. |
|  | B. To have more money than your friends. |
|  | C. To help you actually reach them. |
|  | D. To have vague spending limits. |
...
- https://www.youtube.com/embed/jVqElv4ZXt0?feature=oembed
...
Building a budget or a spending plan is tough. Sticking to the plan is even tougher. Thankfully, there are a few strategies designed to help you develop positive habits. These strategies will help you learn to save, stick with your budget, plan for emergencies, and control your impulse spending.
Budgeting Strategies
Budgeting strategies refer to different ways to approach the task of budgeting in order to build something that works for
you
. There is no one size fits all budget. Every person has different wants and needs, so your budget needs to honestly reflect what is important in your life. Otherwise it’s doomed to fail.
...
With the rise of e-commerce sites like eBay and Amazon, it became easier than ever to buy things you don’t need. If you find yourself receiving packages you can barely remember ordering, it might be time to stop making impulse purchases. One-click ordering options make it very easy to buy something you don’t really need.
Instead of buying something right away, add it to your wish list instead, and wait a week until you place the order. This has two advantages:
While reviewing your wish list, you can remove the items you don’t really need.
